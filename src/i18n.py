...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "Remove":                            "移除",
        "Clear":                             "清空",
        "Clips play top to bottom, in this order.": "片段依由上而下的順序播放。",
        "Add two or more clips to join":     "加入兩個以上的片段才能拼接",
        "No preview":                        "無法預覽",
        "Frame size":                        "畫面尺寸",
        "Frame rate":                        "影格率",
        "Auto":                              "自動",
        ...
        "Padded to fit the output frame":    "已加上留白以符合輸出畫面",
        "Fills the output frame exactly":    "剛好填滿輸出畫面",
        "Pick at least two clips.":          "請至少選擇兩個片段。",
        "sound kept":                        "保留聲音",
